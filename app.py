...
config_script = "<script>window.SGTCP_CONFIG=" + json.dumps(
    {"appsScriptUrl": apps_script_url, "version": "3.0.8"}, ensure_ascii=False
) + ";</script>"
...
html = html.replace('Diseñado y desarrollado por <strong>Bayron Retamal González</strong></small>','SGTCP 3.0.8 · Responsive automático<br>Diseñado y desarrollado por <strong>Bayron Retamal González</strong></small>')
for old in ('SGTCP 3.0 · Diseñado y desarrollado','SGTCP 3.0.3 · Diseñado y desarrollado','SGTCP 3.0.4 · Diseñado y desarrollado','SGTCP 3.0.5 · Diseñado y desarrollado','SGTCP 3.0.6 · Diseñado y desarrollado','SGTCP 3.0.7 · Diseñado y desarrollado'):
    html = html.replace(old, 'SGTCP 3.0.8 · Diseñado y desarrollado')
